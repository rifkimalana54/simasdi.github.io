...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany('App\Models\TypeHewan');
    }

    public function bayars()
    {
        return $this->belongsTo('App\Models\BayarKurban');
    }
    ...
    public function anggota_bkm()
    {
        return $this->hasMany('App\Models\AnggotaBkm');
    }
}
