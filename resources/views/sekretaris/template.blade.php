...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="/dashboard-sekretaris">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" @yield('sidebar-anggota') class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/anggota-bkm">BKM Masjid</a>
                        {{-- <a class="collapse-item" href="register.html">Irmas</a> --}}
                        <a class="collapse-item" href="/sohibul-kurban">Sohibul Qurban</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/messages/sekretaris">
